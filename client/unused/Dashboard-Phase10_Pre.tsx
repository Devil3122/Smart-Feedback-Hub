                              ...
                              <div className="space-y-4 border-t pt-4">
                                ...
                                <div className="space-y-6">
                                  {pendingEdits.map((log: any) => (
                                    <div key={log.id} className="border border-slate-200 dark:border-slate-850 rounded-lg p-4 bg-slate-50/50 dark:bg-slate-900/40 relative space-y-4 shadow-sm">
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="p-3 bg-green-50/30 dark:bg-green-950/10 border border-green-100 dark:border-green-900/50 rounded-lg text-sm">
                                          <div className="font-bold text-xs uppercase text-green-600 dark:text-green-400 mb-2">New Feedback</div>
                                          <QAAccordion textContent={log.proposedText || log.previousText} />
                                      ...
                                      <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-slate-200 dark:border-slate-850">
                                        <div className="text-xs text-slate-400 font-mono">
                                          Submitted: {format(new Date(log.modifiedAt), "MMM d, yyyy h:mm a")}
                                        </div>
